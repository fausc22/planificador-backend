...
// Versión Base64 para crear empleado (NUEVA)
    ...
    try {
        ...
        if (fotoBase64) {
            ...
            if (matches && matches.length === 3) {
                ...
                console.log('⚠️ Formato Base64 inválido, continuando sin foto');
            }
        } else {
            console.log('ℹ️  Sin foto de perfil');
        }

        // Insertar empleado en DB
        ...
        console.error('❌ Error al crear empleado Base64:', error);
        res.status(500).json({
            success: false,
